...
import { ReceiptText, Home, History as HistoryIcon, Camera, MessageSquare, User, Wallet } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="app-container">
      ...
      {/* Floating Bottom Nav — mobile only, desktop tetap pakai navbar atas */}
      <nav className="bottom-nav">
        ...
        <button
          onClick={() => setActiveTab('Riwayat')}
          className={`bottom-nav-link ${activeTab === 'Riwayat' ? 'active' : ''}`}
          aria-label="Riwayat"
        >
          <HistoryIcon size={22} />
        </button>

        <div className="bottom-nav-fab-spacer" />

        <button
          onClick={() => setActiveTab('AI Chat')}
          className={`bottom-nav-link ${activeTab === 'AI Chat' ? 'active' : ''}`}
          aria-label="AI Chat"
        >
        ...
        <button
          onClick={() => setActiveTab('Profil')}
          className={`bottom-nav-link ${activeTab === 'Profil' ? 'active' : ''}`}
        ...
        <button
          onClick={() => setActiveTab('Scan')}
          className={`bottom-nav-fab ${activeTab === 'Scan' ? 'active' : ''}`}
